...
class HomeLanding extends Component {
  constructor() {
    ...
    this.viewDiv = this.viewDiv.bind(this);
  }
  viewDiv = () => {
    this.setState({ divHidden: !this.state.divHidden });
  };
  render() {
    return (
      <>
        ...
        <div className="homePage3">
          ...
          <div className="homePage3_center">
            <div className="homePage3_block homePage3_block1">
              ...
              {this.state.divHidden && (
                <div className="viewLink">
                  <Link to="/trainingOnline">Онлайн</Link>
                  <Link to="/trainingOffline">Офлайн</Link>
                </div>
              )}
            </div>
            ...
            <div className="homePage3_block homePage3_block3">
              Магазин биоэнергетической продукции для успешной и счастливой
              жизни
              <div className="homePage3_block_img">
          ...
          <div className="homePage4_reviews">
            <div className="homePage4_reviews_block">
              ...
              <div className="homePage4_reviews_block_name homePage4_reviews_block_name1">
                Косметолог-эстетист, тренер - преподаватель в Lash Art
                University
              </div>
              <div className="homePage4_reviews_block_review">
                Был страх публичных выступлений, был да сплыл. За пол года было
                не мало выступлений в малых группах, и пока мой рекорд
                300человек.
              </div>
            ...
            <div className="homePage4_reviews_block">
              ...
              <div className="homePage4_reviews_block_review">
                Занимаясь долго саморазвитием, мне было очень интересно ещё
                больше познать себя, научиться новому чувствованию и не набирать
                на себя проблемы клиентов.
              </div>
              <div className="homePage4_reviews_block_appraisal">
                <img src={star} alt="star" />
                <img src={star} alt="star" />
